...
<?php
    ...
    $shrine=["社","宮",];  //寺社名の最後の１文字がこの配列に含まれていたら神社、いなければ寺院
    // $temple=["寺","院","堂","仏","殿","尊","動","師","山","天","塔","音","荷","神",];
    $shrine_kind=["神明","稲荷","八幡","天神","東照","熊野","住吉","祇園","護国","諏訪","大鳥","氷川","大鳥","山王","愛宕","鹿島","香取","水天","白山","春日","三輪","秋葉","浅間","宗像","二荒","天王","大杉","気多","金山","塩釜","猿田彦","三嶋","杵築","丹生","岩木","深砂","金華","駒形","伊佐須美","近津","越王","三吉","鳥海","月山","湯殿","羽黒","赤城","榛名","伊香保","妙義","貫前","息栖","筑波","磯前","妙見","玉前","安房","洲崎","秩父","三峰","宝登","金鑽","高麗","根津","小野","寒川","磯長","雨降","箱根","走湯","小国","入江","大井","真清田","大縣","熱田","針綱","砥鹿","知立","挟投","度津","弥彦","遠敷","気比","織田","菅生","石動","天日陰","二上","立山","高瀬","戸隠","穂高","生島","足島","伊吹","稲葉","水無","建部","多賀","三上","多度","伊雑","淡嶋","竈山","五十猛","日前","国懸","敢国","坐摩","蔵王","一言","子守","松尾","大和","石上","平野","廣瀬","龍田","廣田","生田","長田","恵比寿","賀茂","梅宮","貴船","籠守","出石","粟鹿","養父","宇倍","伊和","吉備津","中山","安仁","速谷","佐陀","倭文","智明","物部","玉祖","琴平","田村","石鎚","磯野","大麻","忌部","杉戸","高鴨","海神","宝満","高良","彦山","鵜戸","霧島","青島","河上","西寒多","阿蘇","都農","十社","天磐戸","新田","開聞",];
    $mount_shrine=["岩木"=>"岩木山","鳥海"=>"鳥海山","月山"=>"月山","湯殿"=>"湯殿山","羽黒"=>"羽黒山","妙義"=>"妙義山","赤城"=>"赤城山","榛名"=>"榛名山","二荒"=>"二荒山","筑波"=>"筑波山","宝登"=>"宝登山","御嶽"=>"御嶽山","雨降"=>"大山(雨降山)","箱根"=>"箱根山","秋葉"=>"秋葉山","浅間"=>"富士山","穂高"=>"穂高岳","戸隠"=>"戸隠山","稲葉"=>"稲葉山","伊吹"=>"伊吹山","弥彦"=>"弥彦山","立山"=>"立山","二上"=>"二上山","白山"=>"白山","石動"=>"石動山","山王"=>"比叡山","三上"=>"三上山","三輪"=>"三輪山","蔵王"=>"金峯山","一言"=>"葛木山","熊野"=>"熊野山","愛宕"=>"愛宕山",
    "松尾"=>"松尾山","稲荷"=>"稲荷山","智明"=>"大神山","石鎚"=>"石鎚山","宝満"=>"宝満山","彦山"=>"英彦山","西寒多"=>"本宮山","阿蘇"=>"阿蘇山","霧島"=>"霧島山","開聞"=>"開聞山","高良"=>"高良山","物部"=>"八百山","三吉"=>"太平山","深砂"=>"猿賀山","金華"=>"金華山",""=>"",""=>"",""=>"",""=>"",""=>"",""=>"",""=>"",""=>"",""=>"",""=>"",];
