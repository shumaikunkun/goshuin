...
<?php
    ...
    $shrine_kind=["神明","稲荷","八幡","天神","東照","熊野","住吉","春日","宗像","山王","祇園","護国","諏訪","大鳥","氷川","大鳥","愛宕","鹿島","香取","水天","白山","三輪","秋葉","浅間","二荒","天王","大杉","気多","金山","塩釜","猿田彦","三嶋","杵築","丹生", "岩木","深砂", "駒形", "金華", "越王","三吉", "鳥海","月山","湯殿","羽黒", "伊佐須美","近津", "赤城","榛名","伊香保","妙義","貫前", "息栖","筑波","磯前","加波", "妙見","玉前","安房","洲崎", "秩父","三峰","宝登","金鑽","高麗", "根津","小野", "寒川","磯長","雨降", "箱根","走湯","小国","入江","大井", "真清田","大縣","熱田","針綱","砥鹿","知立","挟投", "度津","弥彦", "遠敷","気比","織田", "菅生","石動","天日陰", "二上","立山","高瀬", "戸隠","穂高","生島","足島", "伊吹","稲葉","水無", "建部","多賀","三上","阿賀", "多度","伊雑","敢国", "淡嶋","竈山","五十猛","日前","国懸", "坐摩", "大和","石上","廣瀬","龍田","竜王","蔵王","一言","子守", "松尾","平野","賀茂","梅宮","貴船","籠守", "廣田","生田","長田","恵比寿","伊和","出石","粟鹿","養父", "吉備津","中山","安仁", "速谷","黄幡", "宇倍","倭文","智明", "佐陀","物部", "玉祖", "琴平","田村", "石鎚","磯野","伊豫", "大麻","忌部","津峰","杉戸", "高鴨", "海神","高良","彦山","宝満","大幡", "河上", "阿蘇", "西寒多", "都農","鵜戸","青島","高千穂","天岩戸", "霧島","新田","開聞",];
    ...
    "松尾"=>"松尾山","稲荷"=>"稲荷山","智明"=>"大神山","石鎚"=>"石鎚山","宝満"=>"宝満山","彦山"=>"英彦山","西寒多"=>"本宮山","阿蘇"=>"阿蘇山","霧島"=>"霧島山","開聞"=>"開聞山","高良"=>"高良山","物部"=>"八百山","三吉"=>"太平山","深砂"=>"猿賀山","金華"=>"金華山","阿賀"=>"赤神山","黄幡"=>"比治山","津峰"=>"津峰山","加波"=>"加波山",""=>"",""=>"",""=>"",""=>"",""=>"",""=>"",];
