...
<?php
    ...
    $new_old_kanji=["竜"=>"龍","滝"=>"瀧","総"=>"總","仏"=>"佛","沢"=>"澤","国"=>"國","県"=>"縣","剣"=>"劔","気"=>"氣","真"=>"眞","円"=>"圓","医"=>"醫","宝"=>"寶","台"=>"臺","壱"=>"壹","栄"=>"榮","塩"=>"鹽","釜"=>"竈","応"=>"應","岳"=>"嶽","斎"=>"齋","広"=>"廣","厳"=>"嚴","桜"=>"櫻","寿"=>"壽","実"=>"實","写"=>"冩","将"=>"將","浄"=>"淨","条"=>"條","双"=>"雙","体"=>"體","灯"=>"燈","浜"=>"濱","万"=>"萬","弥"=>"彌","予"=>"豫","与"=>"與","恋"=>"戀","幡"=>"旛","島"=>"嶋","箱"=>"函","来"=>"來",];
