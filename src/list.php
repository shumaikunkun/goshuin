...
<?php
    ...
    $shrine_kind=["神明","稲荷","八幡","天満","東照","熊野","住吉","祇園","護国","諏訪","大鳥","氷川","大鳥","山王","愛宕","鹿島","香取","水天","白山","春日","三輪","秋葉","浅間","宗像","二荒","天王","大杉","気多","金山","塩釜","猿田彦","三嶋","出雲","丹生","岩木","駒形","伊佐須美","近津","大物忌","赤城","榛名","伊香保","妙義","貫前","息栖","筑波","磯前","妙見","玉前","安房","洲崎","秩父","金鑽","根津","小野","寒川","磯長","箱根","小国","真清田","大縣","熱田","針綱","砥鹿","知立","挟投","度津","弥彦","遠敷","気比","菅生","石動","天日陰","二上","立山","高瀬","戸隠","穂高","伊吹","稲葉","水無","建部","多度","多賀","加布良古","淡嶋","竈山","伊太祈曽","日前","国懸","敢国","蔵王","松尾","大和","石上","平野","廣瀬","龍田","廣田","生田","長田","恵比寿","賀茂","梅宮","貴船","出石","粟鹿","養父","宇倍","伊和","吉備津","中山","安仁","倭文","玉祖","琴平","大麻","田村","土佐","高良","河上","西寒多","阿蘇","都農","新田","枚聞","総社","天皇","人物",];
