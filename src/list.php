...
<?php
    ...
    $serch_word_example=[["大社","神宮","大神宮",],["清水","成田山","大仏","観音","大師","厄除け","不動","稲荷","国分","塩釜","仙台","天","伏見稲荷","別院","気","妙","伊","聖天","御霊","吉備津","護国","比咩","金閣","総社","長谷","法華","光明","金",],["本能寺","平安神宮","清澄寺","久遠寺","剣神社","妙心寺","常陸国総社","極楽寺","大洗磯前神社","八坂神社","總持寺","住吉大社","榴岡天満宮","大國魂神社","石川護國神社","専修寺","川越大師","秋葉神社","東本願寺","湯島天満宮","本行寺","那古寺","仙波東照宮","大和神社","大神神社",],];
